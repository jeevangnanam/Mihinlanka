        ...
        <tr>
            <td colspan="2" ><table width="260" border="0" cellspacing="1" cellpadding="0">
                    <tr>
                        ...
                        <td><input name="seldcity1" type="text" id="seldcity1" style="width:75px;"/></td>
                        <td><?= __("Depart");?></td>
        ...
        <tr>
            <td colspan="2" ><table width="260" border="0" cellspacing="1" cellpadding="0">
                    <tr>
                        ...
                        <td><input type="text" name="selacity1" id="selacity1"  style="width:75px;"/></td>
        ...
        <tr>
            <td colspan="2" align="left" style='padding:0px;margin:0px;height:1px'>
                <table  border="0" cellpadding="0" cellspacing="0" width="95%">
                    ...
                    <tr>
                        <td><input name="promocode" type="text" id="promocode" />
                        </td>
                        <td align="right">
