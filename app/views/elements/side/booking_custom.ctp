        ...
        <tr>
            <td colspan="2" ><table width="260" border="0" cellspacing="1" cellpadding="0">
                    <tr>
                        ...
                        <td><?= __("Depart");?></td>
                        <td><input type="text" name="selddate1" id="selddate2"  style="width: 65px;background-image: url( '/img/icons/calander.png');background-repeat: no-repeat;padding: 3px 0px 1px 16px;border:solid 1px #999;" value="1 Feb 12"/></td>
                    </tr>
                </table></td>
        ...
        <tr>
            <td colspan="2" ><table width="260" border="0" cellspacing="1" cellpadding="0">
                    <tr>
                        ...
                        <td><select name="selacity1" id="selacity1"  style="width:95px;float:left;"/>
                        <option ></option>  
                        <option value="CMB">Colombo-Sri Lanka (CMB)</option>    
                          <option value="DXB">Dubai (DXB)</option>  
                        ...
                        <td><input type="text" name="seladate1" id="seladate2"  style="width: 65px;background-image: url( '/img/icons/calander.png');background-repeat: no-repeat;padding: 3px 0px 1px 16px;border:solid 1px #999;" value="31 Mar 12" /></td>
                    </tr>
                </table></td>
