												...
												<tr>
													...
													<td valign="middle" style="vertical-align: middle; text-align: left;">
														<h1 class="title" style="margin:0; padding:0; font-size:30px; font-weight: normal; color: #192c45;">
															<span style="font-weight: bold;"><?=Configure::read('app.company.name');?></span> Duty Free shopping.
														</h1>
																...
																<tr>
																	<td valign="top">
																		<table cellspacing="0" cellpadding="0" border="0" align="center" width="100%">
																			<tbody>
																				<tr>
																					<td height="49" width="100%" valign="middle" bgcolor="#c8cfd8" background="<?=Configure::read('app.full_url_with_http');?>/img/email/default/article-title-bg.jpg" style="vertical-align:middle; border-left-width: 1px; border-left-color: #BAC2CC; border-left-style: solid; border-right-width: 1px; border-right-color: #BAC2CC; border-right-style: solid; border-bottom-width: 1px; border-bottom-color: #98a3b4; border-bottom-style: solid; border-top-width: 1px; border-top-color: #BAC2CC; border-top-style: solid;">
																						<h3 class="textshadow" style="margin:0; margin-left: 17px; padding:0; font-size: 18px; font-weight: normal; color:#324258;">
																							Thank you and we recevied your order.</h3>
																					</td>
																				</tr>
																				<tr>
																		...
																		<table cellspacing="0" cellpadding="0" border="0" align="center" width="100%">
																			<tbody>
																				<tr>
																					<td height="49" width="100%" valign="middle" bgcolor="#c8cfd8" background="<?=Configure::read('app.full_url_with_http');?>/img/email/default/article-title-bg.jpg" style="vertical-align:middle; border-left-width: 1px; border-left-color: #BAC2CC; border-left-style: solid; border-right-width: 1px; border-right-color: #BAC2CC; border-right-style: solid; border-bottom-width: 1px; border-bottom-color: #98a3b4; border-bottom-style: solid; border-top-width: 1px; border-top-color: #BAC2CC; border-top-style: solid;">
																						<h3 class="textshadow" style="margin:0; margin-left: 17px; padding:0; font-size: 18px; font-weight: normal; color:#324258;">
																							About <?=Configure::read('app.company.name');?>
																						    PRE-ORDER FACILITY</h3>
																					</td>
																				</tr>
																				<tr>
																						...
																						<table cellspacing="0" cellpadding="0" border="0" align="left" width="190">
																							<tr>
																								<td valign="top" style="padding-right: 20px;">
																									<img width="164" height="164" src="<?=Configure::read('app.full_url_with_http');?>/img/email/default/shopping.png" alt="<?=Configure::read('app.company.name');?> duty free shopping" align="left"  />
																								</td>
																							</tr>
																						</table>
																						<p style="font-size: 12px; line-height: 20px; font-weight: normal; color: #56667d; margin: 0; margin-bottom: 10px;">
																							Mihin Lanka passengers can now enjoy an extensive range of duty free goods on-board. Please ask the cabin crew for a copy of the Duty Free leaflet available on board. You can pre-order your goods and collect them on your return trip. Please speak to the cabin crew for further details.</p>
																					</td>
																				</tr>
																			</tbody>
																		</table>
