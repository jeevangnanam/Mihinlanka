...
<div id="contentInner">
    <h2>Duty Free</h2><br /><br />
    
An extensive range of Duty Free goods are available on- board for Mihin Lanka passengers, with the option of pre-ordering goods required and collecting them on the return trip. 
Please speak to member of the Cabin Crew for further details or to obtain a copy of the Duty Free catalogue available on board. 
...
<!--
    ...
    <?else: ?>
<?= $this->element("translate/$language/pages/duty-free-service-in-mihinlanka"); ?>
    <?endif;?>
