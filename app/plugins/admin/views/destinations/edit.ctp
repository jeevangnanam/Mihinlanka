	...
	<fieldset>
 		<legend><?php __('Edit Destination'); ?></legend>
                <table class="tblStyle" cellpadding="0" cellspacing="1">
                    ...
                    <tr>
                        <td>Code</td>
                        <td><?=$this->Form->input('code',array('label' => false));?></td>
                    </tr>
                    <tr>
                        <td>Place</td>
                        <td><?=$this->Form->input('place',array('label' => false));?></td>
                    </tr>
                    <tr>
                        <td>Country</td>
                    ...
                    <tr>
                        <td>Status</td>
                        <td><?=$this->Form->input('status',array('label'=> false, 'type' => 'select', 'options' => array('APPROVED' => 'APPROVED','NOT_APPROVED' => 'NOT_APPROVED')));?></td>
                    </tr>
                </table>
	<?php
