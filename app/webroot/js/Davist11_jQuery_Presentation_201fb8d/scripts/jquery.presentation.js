    ...
    c.fn.presentation=function(g){
        ...
        c(this).each(function(){
            ...
            a.changeSlide=function(b){
                a.visibleSlide=a.slides.filter(":visible");
                a.slideToShow=a.slides.filter(":nth-child("+b+")");
                switch(a.options.transition){
                    case "show/hide":
                        ...
                        break;
                    case "slide":
                        a.visibleSlide.slideUp(500,function(){
                        a.slideToShow.slideDown(1E3)
                        });
                    break;
                    default:
                        a.visibleSlide.fadeOut(500);
                        a.slideToShow.fadeIn(500)
                        }
        ...
        a.prevNextClick=function(b){
            if(b==="prev")a.count===1?(a.count=a.slides.length):a.count--;else a.count===a.slides.length?(a.count=
                1):a.count++;
        ...
        a.addControls=function(){
            ...
            for(var b='<ol class="'+a.options.pagerClass+'">',d=1;d<a.numSlides+1;d++)b+='<li><a href="#'+d+'">'+d+"</a></li>";
            a.append(b);
            if(a.currentHash){
                ...
                a.append('<ul class="'+
                a.options.prevNextClass+'"><li><a href="#prev" class="prev">'+a.options.prevText+'</a></li><li><a href="#next" class="next">'+a.options.nextText+"</a></li>");
            ...
            c(document).bind("keyup",function(f){
                var e="";
                if(f.keyCode===37)e="prev";
                else if(f.keyCode===39)e="next";
                e!==""&&a.prevNextClick(e)
                })
            };
